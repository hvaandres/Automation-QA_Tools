...
'''
Please remember to change the chrome driver path
...
def selenium_drivers():
    ...
    driver = webdriver.Chrome(executable_path="/home/oem/Desktop/Coding/Selenium/Drivers78/chromedriver")
...
Nubmer = 100   # Number of browsers to be open
thread_list = list()
